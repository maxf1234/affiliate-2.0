...
```
  ...
  <header style={{ background: "#fff", borderBottom: "1px solid #eee", padding: "0 24px", position: "sticky", top: 0, zIndex: 100, boxShadow: "0 1px 8px rgba(0,0,0,0.06)" }}>
    <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: "64px", gap: "16px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "10px", flexShrink: 0 }}>
        ...
        <div>
          <div style={{ fontWeight: "800", fontSize: "17px", color: "#1a1a2e", fontFamily: "'DM Serif Display', serif", lineHeight: 1 }}>DealsPulse</div>
      ...
      <input
        ...
        style={{ flex: 1, maxWidth: "380px", border: "1.5px solid #e5e5e5", borderRadius: "10px", padding: "9px 16px", fontSize: "14px", outline: "none", background: "#fafafa", fontFamily: "'DM Sans', sans-serif" }}
      />
      <div style={{ display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }}>
        <span style={{ fontSize: "12px", color: "#888" }}>Sort:</span>
        <select value={sortBy} onChange={e => setSortBy(e.target.value)}
          style={{ border: "1.5px solid #e5e5e5", borderRadius: "8px", padding: "6px 10px", fontSize: "13px", fontFamily: "'DM Sans', sans-serif", background: "#fff", cursor: "pointer", outline: "none" }}>
  ...
  <div style={{ background: "linear-gradient(135deg, #1a1a2e 0%, #16213e 60%, #0f3460 100%)", color: "#fff", padding: "48px 24px", textAlign: "center" }}>
    <div style={{ maxWidth: "600px", margin: "0 auto" }}>
      ...
      <h1 style={{ margin: "0 0 12px", fontSize: "clamp(28px, 5vw, 42px)", fontWeight: "800", fontFamily: "'DM Serif Display', serif", lineHeight: 1.2 }}>
        The Best Amazon Deals,<br />Hand-Picked for You
      </h1>
      ...
      {!subscribed ? (
        <div style={{ display: "flex", gap: "8px", maxWidth: "420px", margin: "0 auto" }}>
          <input type="email" placeholder="Enter your email for alerts" value={email} onChange={e => setEmail(e.target.value)}
            style={{ flex: 1, border: "none", borderRadius: "10px", padding: "12px 16px", fontSize: "14px", outline: "none", fontFamily: "'DM Sans', sans-serif" }} />
          <button onClick={() => email && setSubscribed(true)}
            style={{ background: "#f90", color: "#111", border: "none", borderRadius: "10px", padding: "12px 20px", fontWeight: "700", fontSize: "14px", cursor: "pointer", fontFamily: "'DM Sans', sans-serif", whiteSpace: "nowrap" }}>
            Get Alerts
          </button>
        </div>
      ) : (
        <div style={{ background: "rgba(76,175,80,0.2)", border: "1px solid #4caf50", borderRadius: "10px", padding: "12px 24px", display: "inline-block", color: "#81c784", fontWeight: "600" }}>
          ✓ You're subscribed! Deals coming your way.
        </div>
      )}
    </div>
  </div>
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", gap: "4px", overflowX: "auto", padding: "12px 0" }}>
      {CATEGORIES.map(cat => (
        <button key={cat} onClick={() => setActiveCategory(cat)}
          style={{ border: "none", borderRadius: "8px", padding: "7px 16px", fontSize: "13px", fontWeight: "600", cursor: "pointer", whiteSpace: "nowrap", fontFamily: "'DM Sans', sans-serif", background: activeCategory === cat ? "#1a1a2e" : "transparent", color: activeCategory === cat ? "#fff" : "#555", transition: "all 0.15s" }}>
          {cat}
        </button>
      ))}
    </div>
  ...
  <div style={{ background: "#1a1a2e", color: "#fff", padding: "40px 24px", textAlign: "center" }}>
    <div style={{ maxWidth: "500px", margin: "0 auto" }}>
      ...
      <h2 style={{ margin: "0 0 10px", fontFamily: "'DM Serif Display', serif", fontSize: "24px" }}>Get Deals on WhatsApp</h2>
  ...
  <footer style={{ background: "#111", color: "#666", padding: "20px 24px", textAlign: "center", fontSize: "12px" }}>
    <p style={{ margin: 0 }}>© 2026 DealsPulse · As an Amazon Associate we earn from qualifying purchases · <span style={{ color: "#f90" }}>Affiliate links support this site</span></p>
  </footer>
</div>
```
